        ...
        "metadata": {
            "platform": {
                ...
                "items": {
                    ...
                    "file_notify_on_upload": {
                        "description": "[飞书] 群聊收到文件时自动通知成员",
                        "type": "bool",
                        "hint": "开启后，群成员上传文件时机器人会发送提醒。需开通 im:message.group_msg 权限以接收群聊文件消息。",
                        "condition": {"type": "lark"},
                    },
                    "file_notify_at_all": {
                        "description": "[飞书] 文件通知时 @ 全体成员",
                        "type": "bool",
                        "condition": {
                            "type": "lark",
